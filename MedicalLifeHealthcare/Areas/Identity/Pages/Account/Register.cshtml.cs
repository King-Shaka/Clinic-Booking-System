...
namespace MedicalLifeHealthcare.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    string applicationName = "Enompilo";
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirm your email",
                        ...
                        $"<body>" +
                        $"" +
                        $"<h1>Welcome to {applicationName} Health Care!</h1>" +
                        $"<p>Dear {userName},</p>" +
                        $"<p>Thank you for registering with us! We're excited to have you on board as our valued patient. Before you can start using your account, please confirm your email address by clicking the button below:</p>" +
                        ...
                        $"<div class='footer'>" +
                        $" <p>Thank you,</p>" +
                        $" <p>{applicationName} health care Team</p>" +
                        $"</div>" +
                        $" </body>" +
                        $"</html>");
