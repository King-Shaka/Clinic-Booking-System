    ...
    public class AppointmentsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            ViewBag.Clinic = (from U in _context.Users
                              ...
                              select U).ToList();
            ViewBag.Appointmnet = await _context.Appointments.Include(a => a.MainUser).Where( e => e.PatientID == user).OrderByDescending(a => a.CreatedAt).ToListAsync();
            return View();
        }
        public async Task<IActionResult> All_Appointments()
        {
            ...
            ViewBag.appoint = _context.Appointments.Include(a => a.MainUser).OrderByDescending(a => a.CreatedAt).ToList();
            return View();
        }
            ...
            else
            {
                if (ModelState.IsValid)
                {
                    ...
                    try
                    {
                        ...
                        {
                            Message = "Appointment for " + appointments.CreatedAt + " has been Successfully Created by our Nurse",
      ...
      public async Task<IActionResult> Accept(int? id)
        ...
        public async Task<IActionResult> Delete_Appointment(int? id)
        {
            ...
            var alerts = new Alert()
            {
                Message = "Appointment for "+ appointments.CreatedAt+" has been Successfully Deleted",
                IntendedUser = user,
                Purpose = "Notification",
            };
            _context.Alerts.Add(alerts);
        ...
        public async Task<IActionResult> Counselling_Appointments()
        {
            ...
            ViewBag.Appointment = _context.Appointments.Where(a => a.Reason == "Counselling").Include(a => a.MainUser).ToList();
            return View();
        }
        // GET: Appointments/Create
        ...
        public async Task<IActionResult> Counselling_Appointment(Appointments appointments)
        {
            ...
            if (appointments.Date_Time != null && appointments.Reason != null)
            {
                ...
                try
                {
                    var alert = new Alert()
                    {
                        Message = "New appointment has been Created Date: "+ appointments.CreatedAt,
                        IntendedUser = user,
                        Purpose = "Notification",
        ...
        public async Task<IActionResult> Accept_Conselling_Appointment(int? id)
        {
            ...
            try
            {
                ...
                var alert = new Alert()
                {
                    Message = "Please note that appointment, dated on " + appointments.CreatedAt + " has been accepted by one of our Consellor",
                    IntendedUser = appointments.PatientID,
                    Purpose = "Notification",
